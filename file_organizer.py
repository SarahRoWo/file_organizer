...
'''
This script organizes images taken from red and green channels and puts them in separate red and green folders. 
...
for each_folder in tifs_folders_sorted:
    ...
    for each_tif_files in tif_files_sorted:
        ...
        for tif_file_data in all_tif_files:
            # get out the red channel data and move to red channel folder
            if 'c1x0' in tif_file_data:
                if 'metadata' in tif_file_data:
                    pass
                else:
                    shutil.move(tif_file_data, 'red')
            # get out the red channel data and move to green channel folder
